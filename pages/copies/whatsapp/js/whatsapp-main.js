(function () {
  ...
  var funnelImages = {
    acquisition: { src: "assets/whatsapp-acquica.png", alt: "Acquisition campaign flow" },
    engagement: { src: "assets/whatsapp-Enagement Card.png", alt: "Engagement campaign flow" },
    retention: { src: "assets/whatsapp-retim.png", alt: "Retention campaign flow" }
  };
  ...
  (function initJourneyCardStack() {
    ...
    var phoneSources = [
      "assets/whatsapp-Phone.png",
      "assets/whatsapp-phone2.png",
      "assets/whatsapp-phone3.png"
    ];
  ...
  (function initBenefitsSwitch() {
    ...
    function activate(card) {
      ...
      var imgSrc = card.getAttribute("data-benefit-img") || "assets/whatsapp-Card Image.png";
