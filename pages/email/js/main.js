(function () {
  ...
  var funnelImages = {
    acquisition: { src: "assets/acquisition-card.png", alt: "Discovery campaign flow" },
    engagement: { src: "assets/acquisition-card.png", alt: "Engagement campaign flow" },
    retention: { src: "assets/acquisition-card.png", alt: "Retention campaign flow" }
  };
  ...
  (function initBenefitsSwitch() {
    ...
    function activate(card) {
      ...
      visual.src = "assets/businessgr.png";
      visual.alt = "High Inbox Rate dashboard";
    }
