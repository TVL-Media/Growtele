(function () {
  ...
  (function initBenefitsSwitch() {
    ...
    function activate(card) {
      ...
      var tabIndex = cards.indexOf(card) + 1;
      visual.classList.remove(
        "benefits__visual--tab1",
        "benefits__visual--tab2",
        "benefits__visual--tab3",
        "benefits__visual--tab4"
      );
      visual.classList.add("benefits__visual--tab" + tabIndex);
