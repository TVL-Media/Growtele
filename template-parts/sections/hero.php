...
<section class="gt-hero" id="hero" aria-label="<?php esc_attr_e( 'Hero', 'growtele' ); ?>">
	...
	<div class="gt-container gt-hero__content">
		...
		<p class="gt-hero__subtitle" data-animate="fade-up" data-animate-delay="200">
			<span class="gt-hero__subtitle-line gt-hero__subtitle-line--primary"><?php esc_html_e( 'Deliver secure, real-time communication experiences', 'growtele' ); ?></span><br />
			<span class="gt-hero__subtitle-line"><?php esc_html_e( 'across SMS, WhatsApp, RCS, Email, and Voice', 'growtele' ); ?></span>
		</p>
