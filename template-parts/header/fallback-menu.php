		...
		<div class="industry-solutions-dropdown" id="industry-solutions-dropdown" data-industry-solutions-dropdown hidden>
			<div class="industry-solutions-dropdown-panel">
				<div class="industry-solutions-dropdown-links">
					...
					<a class="industry-solutions-dropdown-item industry-solutions-dropdown-item--email" href="#" data-industry-solutions-link>
					...
					<a class="industry-solutions-dropdown-item industry-solutions-dropdown-item--whatsapp" href="#" data-industry-solutions-link>
					...
					<a class="industry-solutions-dropdown-item industry-solutions-dropdown-item--rcs" href="#" data-industry-solutions-link>
		...
		<div class="company-dropdown" id="company-dropdown" data-company-dropdown hidden>
			<div class="company-dropdown-panel">
				<div class="company-dropdown-links">
					<a class="company-dropdown-item company-dropdown-item--sms" href="#" data-company-link>
					...
					<a class="company-dropdown-item company-dropdown-item--email" href="#" data-company-link>
					...
					<a class="company-dropdown-item company-dropdown-item--cloud" href="#" data-company-link>
					...
					<a class="company-dropdown-item company-dropdown-item--whatsapp" href="#" data-company-link>
