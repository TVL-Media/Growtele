	...
	<div class="gt-container gt-footer__inner">
		...
		<div class="gt-footer__nav">
			<div class="gt-footer__col">
				...
				<ul>
					<li><a href="#"><?php esc_html_e( 'Whatsapp API', 'growtele' ); ?></a></li>
					<li><a href="#"><?php esc_html_e( 'SMS API', 'growtele' ); ?></a></li>
					<li><a href="#"><?php esc_html_e( 'RCS API', 'growtele' ); ?></a></li>
					<li><a href="#"><?php esc_html_e( 'E-Mail API', 'growtele' ); ?></a></li>
					<li><a href="#"><?php esc_html_e( 'Cloud Telephony', 'growtele' ); ?></a></li>
				</ul>
			</div>
			<div class="gt-footer__col">
				<h4><?php esc_html_e( 'Company', 'growtele' ); ?></h4>
				<ul>
					<li><a href="#"><?php esc_html_e( 'About Us', 'growtele' ); ?></a></li>
					<li><a href="#"><?php esc_html_e( 'Careers', 'growtele' ); ?></a></li>
					<li><a href="#"><?php esc_html_e( 'Contact Us', 'growtele' ); ?></a></li>
				</ul>
			</div>
			<div class="gt-footer__col">
				<h4><?php esc_html_e( 'Resources', 'growtele' ); ?></h4>
				<ul>
					<li><a href="#"><?php esc_html_e( 'Pricing', 'growtele' ); ?></a></li>
					<li><a href="#"><?php esc_html_e( 'API Documentation', 'growtele' ); ?></a></li>
					<li><a href="#"><?php esc_html_e( 'Blog', 'growtele' ); ?></a></li>
				</ul>
			</div>
